// File: app/dashboard/challenge/hard/hardComponents/HardNotes.tsx
"use client";
...
export default function HardNotes() {
    ...
    // hard mode: allow octaves 2..5 (A2, A3, A4, A5)
    const [octave, setOctave] = useState<number>(4);
    const allowedOctaves = [2, 3, 4, 5];
    ...
    return (
        <div className="w-full flex flex-col items-center">
            {/* Guess controls (allowed octaves 2..5). Pass difficulty="hard" for per-difficulty highscores */}
            <GuessChallenge
                playNote={playNote}
            ...
            <OctaveArrowSelector
                octave={octave}
                onDec={() => setOctave((o) => Math.max(2, o - 1))}
                onInc={() => setOctave((o) => Math.min(5, o + 1))}
